...
namespace SeMTG.API.Migrations
{
    ...
    [Migration("20250427130639_ReleasedAtTypeChange")]
    partial class ReleasedAtTypeChange
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SeMTG.API.Models.Card", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SeMTG.API.Models.CardEdition", b =>
                {
                    b.HasOne("SeMTG.API.Models.Card", "Card")
                        .WithMany("Editions")
            ...
            modelBuilder.Entity("SeMTG.API.Models.ImageUris", b =>
                {
                    b.HasOne("SeMTG.API.Models.CardEdition", "CardEdition")
                        .WithOne("ImageUris")
                        .HasForeignKey("SeMTG.API.Models.ImageUris", "CardEditionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CardEdition");
                });
            ...
            modelBuilder.Entity("SeMTG.API.Models.Legalities", b =>
                {
                    b.HasOne("SeMTG.API.Models.CardEdition", "CardEdition")
                        .WithOne("Legalities")
                        .HasForeignKey("SeMTG.API.Models.Legalities", "CardEditionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SeMTG.API.Models.Prices", b =>
                {
                    b.HasOne("SeMTG.API.Models.CardEdition", "CardEdition")
                        .WithOne("Prices")
                        .HasForeignKey("SeMTG.API.Models.Prices", "CardEditionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SeMTG.API.Models.PurchaseUris", b =>
                {
                    b.HasOne("SeMTG.API.Models.CardEdition", "CardEdition")
                        ...
                        .HasForeignKey("SeMTG.API.Models.PurchaseUris", "CardEditionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SeMTG.API.Models.RelatedUris", b =>
                {
                    b.HasOne("SeMTG.API.Models.CardEdition", "CardEdition")
                        .WithOne("RelatedUris")
                        .HasForeignKey("SeMTG.API.Models.RelatedUris", "CardEditionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
